...
global.ownerNumber = ['6287843253876'] //Ganti Jadi Nomer mu Biar Fitur Ownernya Bisa Dipake
global.Rowner = '6287843253876' //Owner Utama
global.ownerName = 'Fahadd-MD' //Ganti Jadi Namamu
global.packname = 'YushaBotz-V7' //Ganti Jadi Nama Botmu
global.author = 'YushaBotz-V7' //Ganti Jadi Namamu
global.prefa = ['','.','#','!'] //Ilangin Prefix Yang '' Kalau Gamau No Prefix
global.sessionName = 'sesi' //Saran Gausah Diganti Lagi
global.webme = 'www.yf-shop.my.id' //Ganti Jadi Bebas Web Sosmed Mu
global.sosmed = 'https://www.instagram.com/oh_pahadd' //Ganti Jadi Web Sosmed Mu
...
global.thumb = fs.readFileSync('./media/YF.jpg')
global.donasi = fs.readFileSync('./media/qris.jpg')
global.thumbnail = fs.readFileSync('./media/YF.mp4')
global.doc = fs.readFileSync('./media/YF.pdf')
